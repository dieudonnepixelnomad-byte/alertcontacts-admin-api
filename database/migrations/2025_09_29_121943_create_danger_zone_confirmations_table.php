...
return new class extends Migration
{
    ...
    {
        Schema::create('danger_zone_confirmations', function (Blueprint $table) {
            $table->id();
            ...
            // Un utilisateur ne peut confirmer qu'une seule fois une zone
    ...
    {
        Schema::dropIfExists('danger_zone_confirmations');
    }
};
